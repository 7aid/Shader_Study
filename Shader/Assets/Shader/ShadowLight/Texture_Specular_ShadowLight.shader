//世界空间下 实现法线纹理shader（附光照阴影）
Shader "MyShader/ShadowLight/Texture_Specular_ShadowLight"
{
    Properties
    {   //材质漫反射颜色
    ...
    SubShader
    {
        ...
        {   //设置光渲染方式，不透明物体使用向前渲染
            ...
            fixed4 frag (v2f data) : SV_Target
            {
                ...
                //获取布林方光照模型
                color = UNITY_LIGHTMODEL_AMBIENT.rgb * albedo + (lambertColor + specularColorBack) * atten;
